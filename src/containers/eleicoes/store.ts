...
export default class EleicoesStore {
  ...
  @observable candidates = {
    "1": {
      ...
      party: "Konoha",
      image:
        "https://cm-santiago-do-cacem.pt/img/fantasy/83/how-watch-naruto-order.jpg",
      votes: 0,
    },
    "2": {
      name: "Goku",
    ...
    "3": {
      ...
      party: "Wayne Corp",
      image:
        "https://veja.abril.com.br/wp-content/uploads/2022/03/batman-oscar.jpg?quality=70&strip=info&w=680&h=453&crop=1",
      votes: 0,
    },
    branco: {
      name: "Branco",
    ...
    "00000": {
      ...
      party: "Nenhum",
      image:
        "https://www.teclasap.com.br/wp-content/uploads/2014/03/voto-nulo.png",
      votes: 0,
    },
  };
  ...
  @computed get getCandidatesVotes() {
    return Object.values(this.candidates).sort((a, b) =>
      a.votes > b.votes ? -1 : 1
    );
  }
  ...
  @action handleFix = () => {
    ...
    if (this.candidateNumber.length > 0) {
      this.playSound(500);
      this.candidateNumber = this.candidateNumber.substring(
        0,
        this.candidateNumber.length - 1
      );
    }
  };
  ...
  @action vote = () => {
    if (this.candidates[this.candidateNumber]) {
      this.candidates[this.candidateNumber].votes =
        this.candidates[this.candidateNumber].votes + 1;
  ...
  @action playSound = (timeout: number) => {
    const audio = new Audio(
      "https://www.adautobulhoes.com.br/locutor/baixar-som-de-urna-eletronica-download-urna-eletronica-som-urna-eletronica-mp3-barulho-urna-eletronica-mp3-toque-urna-eletronica-mp3-efeito-urna-eletronica-mp3-barulho-urna-eletronica-mp3-download-jingle-politico-vereador-e-.mp3"
    );
    audio.play();
    setTimeout(() => {
      audio.pause();
